  ...
  return (
    <section className="relative w-full h-screen md:h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container text-center text-white px-4">
        <h1 className="text-6xl md:text-7xl lg:text-8xl mb-6 leading-tight text-white" style={{fontFamily: 'Playfair Display, serif', fontWeight: '600', textShadow: '2px 2px 4px rgba(0,0,0,0.5)'}}>
  Giovani Sánchez V.
</h1>
